...
class train_statistics:
    ...
    def during_training_step(self,losses):#used once in every iteration to aggregate losses
        ...
        self.detector_reg_losses.append(losses["detector_reg_loss"])
    ...
    def progress_bar_postfix(self):
        ...
        "rpn_reg_loss": "%1.4f" % self.rpn_reg_loss,#TODO:issue with key name
        "detector_class_loss": "%1.4f" % self.detector_class_loss,
        "detector_reg_loss": "%1.4f" % self.detector_reg_loss,#TODO:issue with key name
